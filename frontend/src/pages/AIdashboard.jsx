...
<div className="bg-[#e8ebed]"> 
        ...
        <header className="text-xl font-bold text-white">Calero Cloud Server Management</header>
        ...
        <button className=" gap-4 px-2 py-1 bg-[#1b6a5e] text-indigo-600 rounded-lg hover:bg-[#1b6a5e] text-white">
            Insights </button>
        <button onClick={() => { setCurrPage("policy-editor"); navigate("/policy-editor"); }} className="text-white gap-4 px-2 py-1 bg-[#84a49f]  rounded-lg hover:bg-[#1b6a5e] hover:shadow-md">
      ...
      {/* need to add python script for AI recommendations*/}
        ...
        <h3 className="text-lg font-semibold pt-4">AI Ticket Recommendations</h3>
      <div className="gap-6 flex overflow-x-auto scrollbar-hide  ">
        {tickets.map((ticket, index) => (
          <div key={index} className={` bg-white relative p-4 rounded shadow-sm flex-shrink-0 w-50 h-50`}>
      ...
      <h3 className="text-lg font-semibold pt-4">Data Analytics Overview</h3>
      ...
      <div className="p-6 pb-20 relative w-full h-64 bg-white rounded shadow-sm">
        ...
        <canvas id = "serverGraph">
          
        </canvas>
      </div>
           <div className="p-6 pb-20 relative w-full h-64 bg-white rounded shadow-sm">
        <h3 className="text-center mt-4">Server Usage Graph</h3>
        <canvas id = "serverGraph2">
        </canvas>
      </div>
      </div>
      {/* Server Data Table from components*/}
      <h3 className="text-lg font-semibold pt-4">Cloud Usage Data Per Server</h3>
